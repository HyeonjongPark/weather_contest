...
h24_function = function(dtrain, dtest, plant_num, loc_num) {
  ...
  if(plant_num == 1){
    ...
    if(loc_num == 1) {
      ...
      dtrain$plant_test.x24h_cond_loc = as.factor(dtrain$plant_test.x24h_cond_loc)
      
      set.seed(601)
      x = SMOTE(plant_test.x24h_cond_loc ~., dtrain, perc.over = 5000, perc.under = 1000)
      
      x$plant_test.x24h_cond_loc = as.integer(as.character(x$plant_test.x24h_cond_loc))
      
      data = rbind(x, test_filter) %>% as.data.table()
      data$plant_test.x24h_cond_loc = as.integer(data$plant_test.x24h_cond_loc)
    ...
    if(loc_num == 1) {
      ...
      set.seed(601)
      x = SMOTE(plant_test.x24h_cond_loc ~., dtrain, perc.over = 100000, perc.under = 5000)
...
h48_function = function(dtrain, dtest, plant_num, loc_num) {
  ...
  if(plant_num == 1){
    ...
    if(loc_num == 1) {
      ...
      dtrain$plant_test.x48h_cond_loc = as.factor(dtrain$plant_test.x48h_cond_loc)
      
      set.seed(601)
      x = SMOTE(plant_test.x48h_cond_loc ~., dtrain, perc.over = 5000, perc.under = 1000)
      
      x$plant_test.x48h_cond_loc = as.integer(as.character(x$plant_test.x48h_cond_loc))
      
      data = rbind(x, test_filter) %>% as.data.table()
      data$plant_test.x48h_cond_loc = as.integer(data$plant_test.x48h_cond_loc)
    ...
    if(loc_num == 1) {
      ...
      set.seed(601)
      x = SMOTE(plant_test.x48h_cond_loc ~., dtrain, perc.over = 10000, perc.under = 1000)
      ...
      set.seed(601)
      x = SMOTE(plant_test.x48h_cond_loc ~., dtrain, perc.over = 75000, perc.under = 5000)
